...
class DockedApp(object):
    ...
    def __init__(self):
        ...
        self.active_bg = ActiveBgType.GRADIENT
    ...
    def setup_from_bamf(self, app_match_list):
        ...
        self.icon_name = self.bamf_app.get_icon()
    ...
    def do_expose_event(self, drawing_area, event):
        ...
        if self.is_active and (self.is_dragee is False):
            ...
            if self.active_bg == ActiveBgType.GRADIENT:
                ...
                dbgd = AlphaFillBackgroundDrawer(ctx, self.drawing_area_size,
                                                 self.applet_orient, red, green, blue, 0.33)
